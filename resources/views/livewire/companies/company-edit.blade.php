            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center gap-4">
                        <label class="relative flex-1 flex items-center gap-4 px-4 py-4 bg-[#fbf2ed] border-2 border-dashed {{ $errors->has('logo') ? 'border-red-400' : 'border-[#c1c9b6]' }} rounded-xl cursor-pointer hover:border-[#875212]/60 transition-colors overflow-hidden">
                            ...
                            <div class="min-w-0">
                                ...
                                @elseif($company->logo_path)
                                    <p class="text-sm text-[#1e1b18] font-medium">Logo actuel</p>
                        ...
                        @elseif($company->logo_path)
                            <img src="{{ Storage::url($company->logo_path) }}" alt="Logo actuel" class="w-16 h-16 object-contain rounded-xl border border-[#c1c9b6] bg-white p-1 flex-shrink-0" />
                        @endif
                    </div>
