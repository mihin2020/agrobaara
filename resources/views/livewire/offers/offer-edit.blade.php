<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-[#41493b] text-sm mt-0.5">
                {{ $offer->company->name }} ·
                <span class="font-mono text-xs text-[#615c47]">{{ $offer->reference }}</span>
                <span class="ml-2 text-[10px] font-bold px-2 py-0.5 rounded-full {{ $offer->status->badgeClass() }}">{{ $offer->status->label() }}</span>
            </p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-[#c1c9b6] shadow-sm overflow-hidden">
        ...
        <div class="p-6 space-y-5">
            ...
            <div>
                <label class="block text-sm font-semibold text-[#1e1b18] mb-1.5">Entreprise</label>
                <div class="flex items-center gap-2 px-4 py-2.5 bg-[#f5ece7] border border-[#c1c9b6] rounded-xl text-sm text-[#41493b]">
                    <span class="material-symbols-outlined text-base text-[#875212]">domain</span>
                    {{ $offer->company->name }}
                    <span class="text-xs text-[#717a69] ml-1">(non modifiable)</span>
                </div>
            </div>
    ...
    <div class="bg-white rounded-2xl border border-[#c1c9b6] shadow-sm overflow-hidden">
        ...
        <div class="p-6">
            ...
            <x-skill-picker :skills="$skills" :selected="$skill_ids" accent="offer" />
        </div>
    </div>
